...
/*   Updated: 2025/03/22 16:53:49 by falakus          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (i < game->map_height)
	{
		...
		while (game->map[i][j] != '\0')
		{
			...
			mlx_put_image_to_window(game->mlx->mlx_ptr, game->mlx->win_ptr,
				...
				mlx_put_image_to_window(game->mlx->mlx_ptr, game->mlx->win_ptr, game->mlx->ground, j * 64, i * 64);
			else if (game->map[i][j] == 'P')
				mlx_put_image_to_window(game->mlx->mlx_ptr, game->mlx->win_ptr, game->mlx->player, j * 64, i * 64);
			else if (game->map[i][j] == 'C')
				mlx_put_image_to_window(game->mlx->mlx_ptr, game->mlx->win_ptr, game->mlx->coin, j * 64, i * 64);	
			else if (game->map[i][j] == 'E')
				mlx_put_image_to_window(game->mlx->mlx_ptr, game->mlx->win_ptr, game->mlx->exit, j * 64, i * 64);
			j++;
		}
	i++;
	}
...
void	make_window(t_game *game)
{
	...
	game->mlx->win_ptr = mlx_new_window(game->mlx->mlx_ptr, (game->map_width- 1) * 64, game->map_height * 64, "so_long");
	add_images(game);
}